...
func (m *LocalKeysManager) ImportKey(keyRole string, externalKeyId string) (PrivateKeyHandle, error) {
	return nil, fmt.Errorf("local key manager does not support key import, generate a key instead")
}
...
func (m *LocalKeysManager) AddKey(keyRole string, privateKey PrivateKeyHandle) error {
